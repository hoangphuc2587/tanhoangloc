        ...
        <div class="inside aniview slow" av-animation="fadeIn">
            <div class="mod_article first last block" id="lien-he">
                ...
                <div class="ce_form col-md-6 col-sm-5 form-contact-div col-xs-no-padding-left col-xs-no-padding-right tableless block">
                    ...
                    <form action="<?php echo get_home_url(); ?>/lien-he" id="f1" method="post" enctype="application/x-www-form-urlencoded" class="form-horizontal form-contact">
                        <div class="formbody">
                            ...
                            <div class="widget widget-text input-contact"><label for="ctrl_2" class="input-contact"> Điện thoại </label> <input type="tel" name="phone" id="ctrl_2" class="text input-contact" value="+84-" placeholder="Vui lòng nhập điện thoại bạn" tabindex="2"></div>
                            <div class="widget widget-text input-contact"><label for="ctrl_3" class="input-contact"> Email </label> <input type="email" name="email" id="ctrl_3" class="text input-contact" value="" placeholder="Vui lòng nhập email bạn" tabindex="3"></div>
                            <div class="widget widget-textarea input-contact mandatory"><label for="ctrl_4" class="input-contact mandatory"> <span class="invisible">Trường bắt buộc</span> Nội dung<span class="mandatory">*</span></label> <textarea name="contact" id="ctrl_4" class="textarea input-contact mandatory" rows="2" cols="40" required placeholder="Vui lòng nhập nội dung" tabindex="4"></textarea></div>
                            <div class="widget widget-text input-contact mandatory">
                                ...
                                <input type="hidden" name="question_security_hash" value="b2b83e5a527c48f6a16943c1702af0c0" />
                                <img src="<?php echo get_template_directory_uri()?>/capcha-image.php?12325" class="captcha-image" alt="captcha" /> <input type="tossn_captcha" name="question_security" id="ctrl_5" class="text input-contact mandatory" value="" tabindex="5" required></div>
                            </div>
                            <div class="submit_container"> <input type="submit" id="ctrl_6" class="submit" value="Gửi thông tin"></div>
                        </div>
                    </form>
                </div>
                <!-- indexer::continue -->
